...
export default function App() {
  ...
  return (
    <SafeAreaView style={[GlobalStyles.androidSafeArea, { backgroundColor: screenColors[currentTab]}]}>
      <View style= {{paddingHorizontal: 10, flex: 1, gap: 20 }}>
        <Header setTime={setTime} setCurrentTab={setCurrentTab} currentTab={currentTab}></Header>
        <Timer time={time}></Timer>
        <StartButton isActive={isActive} setIsActive={setIsActive}></StartButton>
      </View>
    </SafeAreaView>
  );
}
